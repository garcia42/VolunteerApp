package com.example.jegarcia.VolunteerMaps.ui.views;/*
...
public class ExpandableTextView extends AppCompatTextView {
    ...
    /**
     * An {@link ExpandableTextView.EllipsizeStrategy} that
    ...
    private class EllipsizeEndStrategy extends EllipsizeStrategy {
        ...
        protected CharSequence createEllipsizedText(CharSequence fullText) {
            ...
            if (fullText instanceof Spanned) {
                TextUtils.copySpansFrom((Spanned) fullText, 0, workingText.length() + ELLIPSIS.length(), null, dest, 0);
            }
            return dest;
        }
